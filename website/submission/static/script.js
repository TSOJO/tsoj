...
let submission_id = document.getElementById('submission-id').innerHTML;
...
function update_results(results) {
    for (let i = 0; i < results.length; i++) {
        let verdict_node = document.getElementById('verdict' + (i + 1));
        let time_node = document.getElementById('time' + (i + 1));
        let memory_node = document.getElementById('memory' + (i + 1));
        if (verdict_node == null) {
            ...
            document.getElementById('results-table-body').appendChild(new_row);
            verdict_node = document.getElementById('verdict' + (i + 1));
            time_node = document.getElementById('time' + (i + 1));
            memory_node = document.getElementById('memory' + (i + 1));
        }
